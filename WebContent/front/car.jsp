						...
						<table class="order-table" id="J_OrderTable">
							...
							<tbody data-spm="3" class="J_Shop">
								<s:iterator var="cartItem" value="#session.cart.cartItems">
									<tr class="item">
										<td><s:property value="#cartItem.product.name" /></td>
										<td><s:property value="#cartItem.product.description" />
										</td>
								...
								<tr class="shop-total blue-line">
									<td colspan="6">店铺合计(<span class="J_Exclude"
										style="display: none">不</span>含运费)： <span
										class='price g_price '> <em
											class="style-middle-bold-red J_ShopTotal"> <s:property
													value="#session.cart.total" /></em> <span>&yen;</span>
									</span>
									</td>
								</tr>
